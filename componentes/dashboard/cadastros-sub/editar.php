  ...
  if(!empty($_GET['id'])){
    ...
    if($result->num_rows > 0){
      while($user_data = mysqli_fetch_assoc($result)){
        ...
        $cpf = $user_data['cpf_cliente'];
        $data = $user_data['nascimento_cliente'];
        $telefone = $user_data['telefone_cliente'];
        $estado = $user_data['estado_cliente'];
        $cep = $user_data['cep_cliente'];
        $cidade = $user_data['cidade_cliente'];
        $bairro = $user_data['bairro_cliente'];
        $rua = $user_data['rua_cliente'];
        $numero = $user_data['numero_cliente'];
        $email = $user_data['email_cliente'];
        $senha = $user_data['senha_cliente'];
      }
    }
    else{
...
<head>
  ...
  <title>Editar Cadastro | Signet</title>
    ...
    <main class="main">
      ...
      <div class="details-registro">
        <div class="recentOrders">
          ...
          <form action="alter_cadastro.php" method="POST" class="details-formulario d-formulario">
          <div>
          ...
          <div>
            <input type="tel" name="telefone" id="telefone" maxlength="11" placeholder="celular" value="<?php echo $telefone ?>">
          </div>
          <div>
            <input type="text" name="cep" id="cep" placeholder="cep" value="<?php echo $cep ?>" onblur="pesquisacep(this.value)">
          </div>
          <div>
          ...
          <div>
            <input type="text" name="bairro" id="bairro" placeholder="bairro" value="<?php echo $bairro ?>">
          </div>
          <div>
            <input type="text" name="rua" id="rua" placeholder="rua" value="<?php echo $rua ?>">
          </div>
          <div>
            <input type="text" name="numero" id="numero" placeholder="numero residencial" value="<?php echo $numero ?>">
          </div>
          <div>
            <input type="email" name="email" id="email" placeholder="email" value="<?php echo $email ?>">
          </div>
          <div>
            <input type="text" name="senha" id="senha" placeholder="nova senha" value="<?php echo $senha ?>">
          </div>
