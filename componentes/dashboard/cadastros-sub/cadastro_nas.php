    ...
    <main class="main">
      ...
      <div class="adm-registro">
        <div class="recentOrders">
          ...
          <form action="./registro_nas.php" method="POST" class="adm-formulario ad-formulario">
          <div>
          <input type="text" name="nasname" id="nasname" placeholder="IP radius">
        </div>
        <div>
          <input type="text" name="shortname" id="shortname" placeholder="nome">
        </div>
        <div>
          <input type="password" name="senha" id="senha" placeholder="senha radius">
        </div>   
        <div>
          <input type="text" name="desc" id="desc" placeholder="descrição">
        </div>
        <input type="submit" name="submit" id="submit" value="Enviar" class="btn">
        <input type="hidden" name="id_nas">
      </form>
        </div>
      </div>
